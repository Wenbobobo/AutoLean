...
| OQ-013 | Which FATE tasks belong to regression and comparison sets after stable hash ordering is frozen? | Do not select by task number except the fixed canary/smoke sets | Prevents benchmark cherry-picking and suite overlap | Benchmark owner | Open |
