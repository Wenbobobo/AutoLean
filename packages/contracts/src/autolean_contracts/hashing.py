...
class HashKindV1(StrEnum):
    ...
    MODEL_OUTPUT_COMMITMENT = "model_output_commitment"
    MODEL_EXECUTION_SETTLEMENT = "model_execution_settlement"
    MODEL_EXECUTION_COMPLETION = "model_execution_completion"
    MODEL_WORK_RUN = "model_work_run"
    MODEL_WORK_CELL = "model_work_cell"
    MODEL_WORK_CASE = "model_work_case"
    MODEL_WORK_CELL_CONTRACT = "model_work_cell_contract"
    MODEL_WORK_CASE_CONTRACT = "model_work_case_contract"
    MODEL_WORK_ITEM = "model_work_item"
