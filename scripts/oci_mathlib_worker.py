...
IMAGE_TAG: Final[str] = "autolean/mathlib-worker:4.28.0-model-theory-source-v1"
...
BUILD_RECEIPT_SCHEMA: Final[str] = "autolean.mathlib-source-build-receipt.v1"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    if arguments.action in {"verify", "canary"} and arguments.image is None:
